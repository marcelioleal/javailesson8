...
//         System.out.println(robotColor);
        ...
        RobotHelper helper = new RobotHelper(8,10);
        Integer result = helper.calculateOperation(robotBlue);
        //Integer result = helper.calculateOperation(newYellow);
        //Integer result = helper.calculateOperation(newBlue);
        //Integer result = helper.calculateOperation(newPurple);
        System.out.println("The Result is: " + result);
    }
}
